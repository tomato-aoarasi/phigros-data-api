...
protected:
	...
	inline static const std::filesystem::path ms_db_phi_player{ Config::getConfig()["db"]["path"]["phi-player"].as<std::string>() };
public:
	...
	inline static sqlite::database PlayerRdDB{ sqlite::database(ms_db_phi_player.c_str()) };
};
#endif